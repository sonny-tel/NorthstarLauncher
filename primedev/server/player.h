...
static_assert(offsetof(CPlayer, m_platformUserId) == 0x1D08);
static_assert(offsetof(CPlayer, m_classModsActive) == 0x1D10);
static_assert(offsetof(CPlayer, m_posClassModsActive) == 0x1D8C);
static_assert(offsetof(CPlayer, m_passives) == 0x1DCC);
static_assert(offsetof(CPlayer, m_selectedOffhand) == 0x4948);
static_assert(offsetof(CPlayer, m_selectedOffhandPendingHybridAction) == 0x1358);
static_assert(offsetof(CPlayer, m_playerFlags) == 0x1E88);
static_assert(offsetof(CPlayer, m_lastUCmdSimulationTicks) == 0x26A8);
static_assert(offsetof(CPlayer, m_lastUCmdSimulationRemainderTime) == 0x26AC);
static_assert(offsetof(CPlayer, m_remoteTurret) == 0x1F04);
static_assert(offsetof(CPlayer, m_hGroundEntity) == 0x414);
static_assert(offsetof(CPlayer, m_titanSoul) == 0x13B8);
static_assert(offsetof(CPlayer, m_petTitan) == 0x2054);
static_assert(offsetof(CPlayer, m_iHealth) == 0x4D4);
static_assert(offsetof(CPlayer, m_iMaxHealth) == 0x4D0);
static_assert(offsetof(CPlayer, m_lifeState) == 0x4F1);
static_assert(offsetof(CPlayer, m_flMaxspeed) == 0x50C);
static_assert(offsetof(CPlayer, m_fFlags) == 0x298);
static_assert(offsetof(CPlayer, m_iObserverMode) == 0x1F64);
static_assert(offsetof(CPlayer, m_hObserverTarget) == 0x1F6C);
static_assert(offsetof(CPlayer, m_hViewModel) == 0x2098);
...
static_assert(offsetof(CPlayer, m_damageImpulseNoDecelEndTime) == 0x1F40);
static_assert(offsetof(CPlayer, m_hasMic) == 0x1E8C);
static_assert(offsetof(CPlayer, m_inPartyChat) == 0x1E8D);
...
static_assert(offsetof(CPlayer, m_traversalState) == 0x22F0);
static_assert(offsetof(CPlayer, m_traversalRefPos) == 0x2328);
static_assert(offsetof(CPlayer, m_traversalForwardDir) == 0x231C);
static_assert(offsetof(CPlayer, m_traversalYawDelta) == 0x2354);
static_assert(offsetof(CPlayer, m_traversalYawPoseParameter) == 0x2358);
static_assert(offsetof(CPlayer, m_grappleHook) == 0x2050);
static_assert(offsetof(CPlayer, m_autoSprintForced) == 0x27C0);
static_assert(offsetof(CPlayer, m_fIsSprinting) == 0x27C4);
static_assert(offsetof(CPlayer, m_sprintStartedTime) == 0x27CC);
static_assert(offsetof(CPlayer, m_sprintStartedFrac) == 0x27D0);
static_assert(offsetof(CPlayer, m_sprintEndedTime) == 0x27D4);
static_assert(offsetof(CPlayer, m_sprintEndedFrac) == 0x27D8);
static_assert(offsetof(CPlayer, m_stickySprintStartTime) == 0x27DC);
static_assert(offsetof(CPlayer, m_smartAmmoPreviousHighestLockOnMeFractionValue) == 0x2998);
static_assert(offsetof(CPlayer, m_activeZipline) == 0x23FC);
static_assert(offsetof(CPlayer, m_ziplineReverse) == 0x2400);
static_assert(offsetof(CPlayer, m_ziplineState) == 0x2410);
static_assert(offsetof(CPlayer, m_duckState) == 0x2250);
static_assert(offsetof(CPlayer, m_StandHullMin) == 0x2254);
static_assert(offsetof(CPlayer, m_StandHullMax) == 0x2260);
...
static_assert(offsetof(CPlayer, m_factionName) == 0x1CE1);
static_assert(offsetof(CPlayer, m_hardwareIcon) == 0x1CF1);
...
static_assert(offsetof(CPlayer, m_bZooming) == 0x1598);
static_assert(offsetof(CPlayer, m_zoomToggleOn) == 0x1599);
static_assert(offsetof(CPlayer, m_zoomBaseFrac) == 0x159C);
static_assert(offsetof(CPlayer, m_zoomBaseTime) == 0x15A0);
static_assert(offsetof(CPlayer, m_zoomFullStartTime) == 0x15A4);
static_assert(offsetof(CPlayer, m_camoIndex) == 0xA04);
static_assert(offsetof(CPlayer, m_decalIndex) == 0xA08);
